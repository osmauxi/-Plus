...
namespace ProjectGame.HotFix.Gameplay.Player.Movement
{
    ...
    public struct PlayerMotionState
    {
        ...
        public float PivotBoostTimeRemaining { get; internal set; }
        public float PivotBoostSpeedBonus { get; internal set; }
        public bool HasMoveInput { get; internal set; }
        public bool IsMoving { get; internal set; }
        public bool IsPivoting { get; internal set; }
        public bool IsPivotBoosting => PivotBoostTimeRemaining > 0f && PivotBoostSpeedBonus > 0f;
    }
    ...
    public readonly struct PlayerMotorRuntimeState
    {
        ...
        public float PivotBoostTimeRemaining { get; }
        public float PivotBoostSpeedBonus { get; }
        ...
        public PlayerMotorRuntimeState(
            ...
            float pivotBoostTimeRemaining,
            float pivotBoostSpeedBonus)
        {
            Position = position;
            Rotation = rotation;
            Velocity = velocity;
            ...
            PivotBoostTimeRemaining = pivotBoostTimeRemaining;
            PivotBoostSpeedBonus = pivotBoostSpeedBonus;
        }
    }
}
